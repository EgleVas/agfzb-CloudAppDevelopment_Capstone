...
def login_request(request):
    ...
    if request.method == "POST":
        ...
        if user is not None:
            ...
            print("Invalid username or password".format(request.user.username))
...
def get_dealerships(request):
    context = {}
    url ='https://eglevasilevi-3000.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/dealerships/get'
...
def get_dealer_details(request, dealer_id):
    if(request.method == "GET"):
        context = {}
        dealer_url = "https://eglevasilevi-3000.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/dealerships/get"
        reviews_url = "https://eglevasilevi-5000.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/get_reviews"
...
def add_review(request, dealer_id):
    if(request.method == "GET"):
        ...
        if(request.user.is_authenticated):
            url = "https://eglevasilevi-5000.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/post_review"
            review = dict()
            review["id"] = 1
